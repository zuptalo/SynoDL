...
while [ $i -le $# ]; do
    ...
    case "$arg" in
        ...
        --help|-h)
            ...
            echo "  --category <c>      SynoDL spec band: planned (0001+), adhoc (1001+), hotfix (2001+)."
...
# --- SynoDL category bands -----------------------------------------------------
# SynoDL partitions spec numbers by category so the number itself signals intent:
