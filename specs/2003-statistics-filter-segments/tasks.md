...
- [x] T001 [US1] In `src/components/StatisticsView.vue`, wrap the source segment (grouped with the
  ...
  "Open to" segment.
- [x] T002 Gate: `npm run build` + `npm run test:unit`; `make roadmap`; bump version; open PR. Manual:
