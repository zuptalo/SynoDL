...
- [ ] T001 [US1] Add `src/services/quality-sort.ts` (pure `sizeMB`, `seasonNum`, `bySeasonThenSize`)
...
- [ ] T002 [US1] In `src/components/SourceTitleModal.vue`, use `bySeasonThenSize` for `visibleQualities`,
